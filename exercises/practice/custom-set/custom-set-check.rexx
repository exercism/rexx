...
check('difference of two non-empty sets is a set of elements that are only in the first set' 'SetDifference(fullSet1, fullSet2)',,
      'SetDifference(fullSet1, fullSet2)',, 'to be', diffFullSet1And2)
